            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <a type="button" class="btn btn-primary" id="ProceedButton">Add to favourites</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <?php
        if(isset($_GET['product_id']))
        {
            ...
            if($insert)
            {
                ?>
                <script>
                    document.getElementById("AlertHeader").innerHTML = "Item Added to favourites";
                    document.getElementById("AlertHeader").classList.add("text-success");
                    $("#ProceedButton").attr("href", "../favourites.php");
