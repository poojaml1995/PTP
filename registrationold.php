                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    if ($result1 && $result2) {
                                        try {
                                            ...
                                            $mail->SMTPAuth = true;
                                            $mail->Username = "donotreplyproficiencytesting@gmail.com";
                                            $mail->Password = "mkrx thqt erwj tbqi";
                                            $mail->SMTPSecure = "tls";
                                            $mail->Port = 587;
                                            $mail->setFrom("donotreplyproficiencytesting@gmail.com", "CMTI PTP");
                                            $mail->AddAddress($email);
                                            $mail->isHTML(true);
                                            $mail->AddReplyTo("donotreplyproficiencytesting@gmail.com", "CMTI PTP");
